...
class TogetherProvider(BaseProvider):
    ...
    def _get_api_url(self) -> str:
        return self._config.base_url or "https://api.together.xyz/v1"
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        model_name = model or self._config.default_model or "together_ai/mistralai/Mixtral-8x7B-Instruct-v0.1"
    ...
    async def list_models(self) -> list[ModelInfo]:
        try:
            models = await litellm.amodel_list(
                model=f"together_ai/{self._config.api_key or ''}",
            ...
            return [
                ModelInfo(
                    model_name=self._config.default_model or "together_ai/mistralai/Mixtral-8x7B-Instruct-v0.1",
                    provider=self.name,
                )
            ]
