...
class OllamaProvider(BaseProvider):
    ...
    def _get_api_url(self) -> str:
        return self._config.base_url or "http://localhost:11434"
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        model_name = model or self._config.default_model or "ollama/llama2"
    ...
    async def list_models(self) -> list[ModelInfo]:
        try:
            ...
            return [
                ModelInfo(
                    model_name=self._config.default_model or "ollama/llama2",
                    provider=self.name,
                )
            ]
